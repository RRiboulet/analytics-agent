...
def register(mcp: FastMCP, client: PostgresClient) -> None:
    @mcp.tool(
        name="list_factory_tables",
        description="List the public tables available in the sample factory PostgreSQL database.",
        annotations=ToolAnnotations(
            title="List factory tables",
            readOnlyHint=True,
